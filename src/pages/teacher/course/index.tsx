...
function CourseList() {
  ...
  const [platorms,_setPlatforms] = useState<Course[]>([{
    ...
    created_at:0,
    description:'为openInula构建完善的类型系统，使用TypeScript为openInula API、JSX/TSX 提供完善的类型校验与代码补全提示',
    studied_by:100,
    tag:'前端开源',
    title:'openinula类型开发',
    updated_at:0,
  ...
  return (
    <>
    <div className="max-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
      {/* 装饰元素 */}
